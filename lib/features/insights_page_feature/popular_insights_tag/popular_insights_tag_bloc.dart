...
class PopularInsightsTagBloc{
  ...
  String _insightsTag;
  String get getInsightsTag => _insightsTag;
  set setInsightsTag(String insightsTag) {
    _insightsTag = insightsTag;
  }
  ...
  PopularInsightsTagBloc({@required String tag}){
    ...
    FirebaseAuth.instance.currentUser().then((FirebaseUser firebaseUser){
      ...
      if (firebaseUser != null){
        ...
        int queryLimitForFirstInsightsLoad = 5;

        loadInsights(insightsQueryLimit: queryLimitForFirstInsightsLoad, tag: getInsightsTag);
      }
  ...
  void loadInsights({@required int insightsQueryLimit, @required String tag}){
  ...
  Future<void> loadMoreInsights({ @required int insightsQueryLimit, List<dynamic> currentUserDogFollowingList, @required String tag})async{
  ...
  Future<List<InsightModel>> getInsightsData({
    ...
    if (startAfterMap == null){
      ...
      querySnapshot = await Firestore.instance
          ...
          .where(InsightDocumentFieldName.tags, arrayContains: tag)
          .limit(queryLimit)
          .getDocuments();
    }
    else{
